...
mixin _$CoinDetailsViewModel on ICoinDetailsViewModel, Store {
  ...
  Atom(name: 'ICoinDetailsViewModel.crypto', context: context);
  ...
  Atom(name: 'ICoinDetailsViewModel.isLoading', context: context);
  ...
  Atom(name: 'ICoinDetailsViewModel.errorMessage', context: context);
  ...
  AsyncAction('ICoinDetailsViewModel.getDetails', context: context);
